...
export default function ScreenPage() {
  ...
  const showTextWithImage = hasImage && hasMessage && currentItem.showText !== false;
  const isImageOnly = hasImage && (!hasMessage || currentItem.showText === false);
  const isTextOnly = !hasImage && hasMessage;
